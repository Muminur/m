...
pub fn query_transcripts(
    conn: &Connection,
    id: &str,
) -> Result<(Vec<crate::database::transcripts::TranscriptRow>, u64), AppError> {
    let folder = conn
        .query_row(
    ...
    let filter: crate::database::transcripts::ListFilter =
        serde_json::from_str(&folder).unwrap_or_default();
...
mod tests {
    ...
    fn test_query_smart_folder_transcripts() {
        ...
        .unwrap();
        crate::database::transcripts::update(
            &conn,
            &tid,
            &crate::database::transcripts::TranscriptUpdate {
                title: None,
                language: None,
        ...
        .unwrap();
        // Insert unstarred
        crate::database::transcripts::insert(
            &conn,
            &crate::database::transcripts::NewTranscript {
                title: "Other".into(),
                duration_ms: None,
